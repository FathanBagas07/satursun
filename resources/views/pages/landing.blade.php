            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ms-auto align-items-lg-center my-3 my-lg-0">
                    ...
                    <li class="nav-item text-center mt-2 mt-lg-0 ms-lg-2">
                        <a href="{{ route('login') }}" class="btn btn-outline-secondary rounded-pill px-4 w-100">Masuk</a>
                    </li>
                    @else
                    @auth
                    ...
                    <li class="nav-item text-center mt-2 mt-lg-0 ms-lg-2">
                        <a href="{{ route('poster.jobs.create') }}" class="btn btn-primary rounded-pill px-4">Buat Tugas Baru</a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarNotificationDropdown">
                            ...
                            <li class="d-flex justify-content-between align-items-center dropdown-item-text">
                                ...
                                <form method="POST" action="{{ route('notifications.destroy', $notification) }}" class="ms-auto">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-outline-danger border-0 p-0" title="Hapus notifikasi">
                    ...
                    <li class="nav-item dropdown text-center text-lg-start ms-lg-3">
                        <a class="nav-link dropdown-toggle d-inline-flex align-items-center justify-content-center gap-2" href="#" id="navbarUserDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            @php
                            $photo = optional(auth()->user()->profile)->photo ?? null;
                            @endphp

                            @if($photo)
                            <img src="{{ Storage::url($photo) }}" alt="{{ auth()->user()->name }}" class="rounded-circle" width="32" height="32" style="object-fit: cover;">
                            @else
                            <span class="d-inline-flex justify-content-center align-items-center bg-secondary text-white rounded-circle" style="width: 32px; height: 32px;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdown">
                            <li><a class="dropdown-item text-center text-lg-start" href="{{ route('profile.edit') }}">Edit Profil</a></li>
                            <li>
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}" class="mb-0">
                                    @csrf
                                    <button type="submit" class="dropdown-item text-center text-lg-start">Keluar</button>
                                </form>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="row align-items-center bg-hero rounded-5">
                <div class="col-md-8 p-5">
                    ...
                    <div class="d-flex mt-4">
                        <a href="{{ route('auth.choose') }}" class="btn btn-daftar btn-lg">
